...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<td height="70" colspan="2" class="logo" nowrap="nowrap">Cadastro de Serviços  <span class="tagline"></td>
	<td width="458">&nbsp;</td>
	</tr>
	...
	<form id="form1" name="form1" method="post" action="cadastroServicos.php">
      
     <label for="codServico">Código
	  <input id="codServico" name="codServico" type="text" required />
	  </label>
	  	  <br />
	      <br />
	  ...
	  <input id="vlServico" name="vlServico" type="float" step="0.01" required />
	  </label>
	  	  <br />
	      <br />
